...
public class ChatFactory {
    ...
    public void sendPlayerMessage(String s, boolean wantPrefix, Player p, String prefix) {
        if (wantPrefix) {
            p.sendMessage(colorString(prefix + " &r" + s));
        } else {
            p.sendMessage(colorString("&r" + s));
        }
    }

    public void sendPlayerMessage(String s, boolean wantPrefix, CommandSender sender, String prefix) {
        if (wantPrefix) {
            sender.sendMessage(colorString(prefix + " &r" + s));
        } else {
            sender.sendMessage(colorString("&r" + s));
        }
    }

    public void sendConsoleMessage(String s, String prefix) {
        Bukkit.getConsoleSender().sendMessage(colorString(prefix + " &r" + s));
    }
